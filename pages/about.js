...
export default function () {
  return (
    <Box my={30} mx={'auto'} maxW={["90%", "90%", "90%", "50%"]}>
      <Text mb={2}>I got more serious about cycling in 2020 as a way to stay healthy and explore the city, and got the idea to ride to every park in the Seattle. I did not expect there to be close to four hundred!</Text>
      <Text mb={2}>Along the way, I learned about the P-Patches, so I also rode my bike to every P-Patch.</Text>
      <Text mb={2}>Along the way, I learned about the Seattle Port Authority owned parks, so I rode my bike to every Port Authority owned park.</Text>
